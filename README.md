...
[![Development Branch](https://img.shields.io/badge/branch-development-green)](https://github.com/amarala931/pItAgorin/tree/development)
...
The project follows a modular architecture available in the [development branch](https://github.com/amarala931/pItAgorin/tree/development):
...
```bash
git clone -b development [https://github.com/amarala931/pItAgorin.git](https://github.com/amarala931/pItAgorin.git)
cd pItAgorin
```
